...
package kr.ac.becaforfoundation.domain.hyperledger.ledgerapi.impl;


import kr.ac.becaforfoundation.domain.hyperledger.ledgerapi.State;
import kr.ac.becaforfoundation.domain.hyperledger.ledgerapi.StateDeserializer;
import kr.ac.becaforfoundation.domain.hyperledger.ledgerapi.StateList;
import kr.ac.becaforfoundation.domain.hyperledger.ledgerapi.StateSerializer;
...
public class StateListImpl implements StateList {
     ...
     * @param deserializer
     */
    public StateListImpl(Context ctx, String listName, StateDeserializer deserializer, StateSerializer serializer) {
        this.ctx = ctx;
        this.name = listName;
    ...
    public StateList addState(State state) {
        ...
        byte[] data = this.serializer.serialize(state);
    ...
    public State getState(String key) {
        ...
        byte[] data = null;
        data = this.ctx.getStub().getState(ledgerKey.toString());
