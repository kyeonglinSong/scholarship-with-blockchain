...
import kr.ac.becaforfoundation.domain.hyperledger.ledgerapi.impl.StateListImpl;
...
public interface StateList {
     ...
     */
    static StateList getStateList(Context ctx, String listName, StateDeserializer deserializer, StateSerializer serializer) {
        return new StateListImpl(ctx, listName, deserializer, serializer);
    }
